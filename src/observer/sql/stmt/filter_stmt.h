...
public:
  ...
  void set_filter_mode(CondMode mode)
  {
    filter_mode_ = mode;
  }

  CondMode filter_mode() const
  {
    return filter_mode_;
  }
...
public:
  ...
  static RC create_push_down_filters(Db *db, Table *table, std::unordered_map<std::string, Table *> *tables,
...
private:
  ...
  CondMode filter_mode_ = AND_MODE;
};
